export default function Services() {
    ...
    return <section className="bg-white dark:bg-gray-900 my-[74px]">
        <div className="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6 flex justify-center flex-col items-center">
            <div className="max-w-screen-md mb-8 lg:mb-16 text-center">
                <h2 className="mb-4 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white">
                    Designed for business teams like yours
                </h2>
                <p className="text-gray-500 sm:text-xl dark:text-gray-400">
                At our agency, we prioritize markets where technology, innovation, and capital can unleash lasting value and propel economic expansion.
                </p>
            </div>
